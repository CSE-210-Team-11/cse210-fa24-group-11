...
export const motivationalQuotes = [
	...
	{
		text: "The only thing that separates successful people from the ones who aren't is how badly they want it",
		author: "Unknown",
	},
	{
		text: "The only thing that stands between you and your dream is the will to try and the belief that it is actually possible",
	...
	{
		text: "The chief cause of failure and unhappiness is trading what you want most for what you want right now",
		author: "Zig Ziglar",
	},
	{
	...
	{
		text: "Comfort and growth cannot coexist",
	...
	{
		text: "The only way that we can live is if we grow",
		author: "Maya Angelou",
	},
	{
	...
	{
		text: "Change is the only constant in life, and it's also your greatest propeller",
		author: "Tony Robbins",
	},
	{
	...
	{
		text: "Never be satisfied with what you achieve, because it all pales in comparison with what you are capable of doing in the future",
		author: "Rabbi Nochem Kaplan",
	},
	{
	...
	{
		text: "Success is not about being brilliant, it's about being consistent",
		author: "Anonymous",
	},
	{
	...
	{
		text: "The only limitations one has are the ones they place on themselves",
		author: "Muhammad Ali",
	},
];
